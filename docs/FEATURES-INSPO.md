...
| [Grok Build headless guide](https://github.com/xai-org/grok-build/blob/main/crates/codegen/xai-grok-pager/docs/user-guide/14-headless-mode.md) | `--reasoning-effort`, `--yolo`, `--resume`, JSON and streaming JSON output are documented | Explicit reasoning and auto-approve controls map only to those documented flags | Hidden permission escalation or a vague “full authorization” switch |
