...
export function QuickEntry() {
  ...
  return <main class="quick-entry" aria-label="Grok Build Quick Entry">
    <header><div><span class="quick-entry__mark">✦</span><strong>Grok Build</strong><small>Quick Entry</small></div><button onClick={() => void window.api.quickEntry.close()} aria-label="Close Quick Entry">×</button></header>
