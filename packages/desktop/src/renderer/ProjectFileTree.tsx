...
export function ProjectFileTree(props: { files: WorkspaceFile[]; query: string; activePath: string; onSelect: (path: string) => void; onPreview?: (path: string) => void }) {
